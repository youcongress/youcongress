  ...
  describe "execute/2" do
    test "returns the most recent unverified quotes with statements and votes" do
      opinion = %{
        ...
        opinion_statements: [%{statement_id: 8, verification_status: :ai_verified}]
      }
